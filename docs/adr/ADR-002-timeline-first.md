...
- Status: Accepted
- Date: 2026-07-02
- Amended: 2026-07-03 — CEO Decision: VaultFolder Curation is Future Work
- Related: PRD §4.3 Timeline First, §6 MVP Goal, [EVENT_ENGINE.md](../EVENT_ENGINE.md)
...
3. MVP에서 VaultFolder Curation은 제외한다. MVP 탐색은 Timeline, Deterministic Metadata, Search로 제공한다.
...
- (+) AI 모델/로직이 바뀌어도 Log/Timeline 원본은 영향받지 않는다.
- (−) MVP 사용자는 "2026-07-12 서울숲 데이트" 같은 자동 요약이나 수동 추억 폴더를 얻지 못하고, Timeline과 Search로 직접 다시 찾아야 한다.

...
**Phase 3 — 진행 중** (Storage Layout RFC Draft)
...
Phase 3 — Storage Layout RFC

`DATA_MODEL.md` v0.3은 다음 CEO 결정을 반영한다.
...
기록 방식: 1, 2, 3, 5는 `DATA_MODEL.md` v0.3 승인 범위에 묶고, 4는
ADR-007, 6은 ADR-006으로 기록한다.
...
- [docs/PRD.md](docs/PRD.md) — 제품 정의 (v0.2.4)
...
## Phase 3 Gate Preparation

- [x] Storage Layout RFC Draft 작성
- [ ] Fable Storage Layout RFC Review
- [ ] CEO final approval

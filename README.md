...
**Phase 3 — 진행 중** (VaultFolder De-scope + Storage Layout RFC Draft)
...
`DATA_MODEL.md` v0.4 Draft는 다음 CEO 결정을 반영한다.
...
- [docs/PRD.md](docs/PRD.md) — 제품 정의 (v0.2.5 Draft)
- [CHANGELOG.md](CHANGELOG.md) — PRD/주요 결정 변경 이력
- [docs/DATA_MODEL.md](docs/DATA_MODEL.md) — Log / Timeline / Search / View 데이터 모델 (v0.4 Draft)
